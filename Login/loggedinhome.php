...
<?php else: ?>
    <span data-tooltip="Login" data-flow="top">
        <a href="../Payment_Interface/payment.html" class="fas fa-user"></a>
    </span>
<?php endif; ?>
...
<header>
    ...
    <div class="icons">
        <span data-tooltip="Favorites" data-flow="top"><a href="./favorites.php" class="fas fa-heart"></a></span>
    ...
    <div class="box-container">
        ...
        <div class="box">
            <div class="image">
                ...
                <div class="icons">
                    <a href="../favorites.php?add=Morocco" class="fas fa-heart"></a>
                    <a href="../Payment_Interface/payment.html" class="cart-btn">Visit Us</a>
                    <a href="../Payment_Interface/payment.html" class="fas fa-share"></a>
                </div>
            </div>
            <div class="content">
                <h3>Morocco</h3>
